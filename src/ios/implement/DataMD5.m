...
//创建发起支付时的sige签名
-(NSString *)createMD5SingForPay:(NSString *)appid_key partnerid:(NSString *)partnerid_key prepayid:(NSString *)prepayid_key package:(NSString *)package_key noncestr:(NSString *)noncestr_key timestamp:(UInt32)timestamp_key partnerkey:(NSString *)par{
    ...
    self.partnerkey = [viewController.settings objectForKey:@"private_key"];

    //添加商户密钥key字段
    [contentString appendFormat:@"key=%@", par];
